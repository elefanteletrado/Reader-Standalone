...
MediaOverlay = Backbone.Model.extend({
  ...
  initialize: function () {
    ...
    this.audioplayer.setNotifyOnPause(function () {
      self.set({
        is_playing: self.audioplayer.isPlaying()
      });
    });
    ...
    this.smilModel.addRenderers({
      ...
      "text": function () {
        ...
        self.set({
          ...
          current_is_last_child: $(this).parent().is(':last-child')
        });
